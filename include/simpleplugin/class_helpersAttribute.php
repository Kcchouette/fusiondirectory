...
class MailAttribute extends TestValidateAttribute
{
  ...
  protected string $testFunc   = 'is_email';
...
{
  protected string $testFunc = 'is_valid_hostname';
}
...
{
  protected string $testFunc = 'is_uid';
}
...
class PathAttribute extends TestValidateAttribute
{
  ...
  protected string $testFunc = 'is_path';
}
...
{
  protected bool $trim       = TRUE;
  protected string $testFunc   = 'is_url';
...
class IPAttribute extends TestValidateAttribute
{
  ...
  protected string $testFunc = 'is_ip';
}
...
class IPv4Attribute extends TestValidateAttribute
{
  ...
  protected string $testFunc = 'is_ipv4';
}
...
class IPv6Attribute extends TestValidateAttribute
{
  ...
  protected string $testFunc = 'is_ipv6';
}
